...
<body>
  ...
  <a href="feedback.php">Feedback</a>
	...
	<div class="box" style="margin-top: 0px;">
		...
		<form style="margin-top: 0;" id="myform" action="update.php" method="post">
		<span class="icon"><i class="fa fa-university" aria-hidden="true" style="color:white;"></i></span><input  autocomplete="off"type="text" list="branch" name="branch" style="border: 2px solid lightgrey;" placeholder="Branch" >
		<datalist id="branch">
			<option value="CE">
			<option value="CSE">
			<option value="IT">
		</datalist><br>
		<span class="icon"><i class="fa fa-graduation-cap" aria-hidden="true" style="color:white;"></i></span><input autocomplete="off"type="number" list="sem"name="sem" style="border: 2px solid lightgrey;" placeholder="Semester" >
			<datalist id="sem">
			<option value="1">
			<option value="2">
			<option value="3">
