<?php
	...
	if( $_POST['submit'] == "Delete")
		{		
			...
			if(!$result)
			{
				echo "<script> alert('No data Avaliable.');window.location='deletehome.php'; </script>";
			}
...
<body>
  ...
  <a href="feedback.php">Feedback</a>
		...
		<div class="barbox" id="myDIV" style="display: none;">
			<i class="fa fa-times-circle fa-lg" aria-hidden="true" style="left:50%;" onclick="hide();">
	...
	<div class="box" style="width: 70%;top:15%;height:auto;" >
				<h3> Delete Details <br>
					<br> Branch :- <?php echo $branch; ?> & Semester :- <?php echo $sem; ?></h3>
			<form action="display.php" method="post" id="myform" >
			<div id="oform" style="display: block;">
				<div class="btn" style="margin-bottom: 20px;">
					<input type="hidden" name="branch" value="<?php echo $branch; ?> ">
					<input type="hidden" name="sem" value="<?php echo $sem;?>">
					<input type="submit" name="submit" value="Delete All">
					<input type="button" name="submit" value="Delete Specific" onclick="f();" >
				</div>		
			</div>	
				<div style="text-align: center;margin-left: 10px;position: relative;display: none;" id="iform">
					 <span class="icon">
						<i class="fa fa-pencil" aria-hidden="true" style="color:white;">
						</i>
					 </span>
					<input type="number" name="eno"  placeholder="Enter a Enrollement Number" autocomplete="off">
					<span class="btn">
